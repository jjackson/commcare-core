...
class XPathFilterExpr : XPathExpression {
    ...
    lateinit var x: XPathExpression
    ...
    override fun equals(other: Any?): Boolean {
        if (other is XPathFilterExpr) {
            @Suppress("UNCHECKED_CAST")
            return x == other.x && ExtUtil.arrayEquals(predicates as Array<Any?>, other.predicates as Array<Any?>, false)
        } else {
            return false
        }
    }
