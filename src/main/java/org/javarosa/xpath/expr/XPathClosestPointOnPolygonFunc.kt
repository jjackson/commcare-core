 ...
 * - `polygon_coords`: A space-separated string of lat/lon pairs (e.g. "'27.174957 78.041309 27
 *   .174884 78.042574 27.175493 78.042661 27.175569 78.041383'")
 *
 * **Returns:**
 * The closest point on the polygon's boundary to the input point, in "lat lon" format. If the input is
 ...
 */
class XPathClosestPointOnPolygonFunc : XPathFuncExpr {
    ...
    companion object {
        @JvmField
        val NAME = "closest-point-on-polygon"
