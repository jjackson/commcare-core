...
class XPathChecksumFunc : XPathFuncExpr {
    ...
    companion object {
        ...
        @JvmField
        val ALGORITHM_KEY_VERHOEFF = "verhoeff"
        ...
        private fun checksum(o1: Any, o2: Any): String {
            ...
            return when (algorithmKey) {
                ...
                else -> throw XPathUnsupportedException(
                    "Bad algorithm key $algorithmKey. We only support 'verhoeff' as algorithm key right now."
                )
            }
        }
         ...
         * @see [Based on Verhoeff checksum implementation here](https://en.wikibooks.org/wiki/Algorithm_Implementation/Checksums/Verhoeff_Algorithm.Java)
         */
            ...
            for (i in inputList.indices) {
                ...
                try {
                    ...
                    throw XPathUnsupportedException(
                        "Illegal character '${inputList[i]}' in input for Xpath function checksum()"
                    )
                }
