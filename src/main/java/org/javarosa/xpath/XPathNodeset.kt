...
open class XPathNodeset {
    ...
    open fun unpack(): Any? {
        ...
        return if (size() == 0) {
            ...
            throw XPathTypeMismatchException(
                "XPath nodeset has more than one node [" + nodeContents() +
    ...
    protected fun getInvalidNodesetException(): XPathTypeMismatchException {
                ...
                throw XPathTypeMismatchException(
                    MessageFormat.format(
                        "Logic references {0} which is not a valid question or value." +
                                ...
                                "(e.g. /data/{0}). (Expanded reference: {1})",
                        originalPath, pathEvaluated
                    )
                )
            } else {
                throw XPathTypeMismatchException(
