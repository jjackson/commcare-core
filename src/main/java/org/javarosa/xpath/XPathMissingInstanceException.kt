...
class XPathMissingInstanceException : XPathException {
    @JvmField
     ...
     */
    constructor(refThatNeededInstance: TreeReference) : super(
        "No instance was found with which to resolve reference: $refThatNeededInstance"
    ) {
